...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/petcity',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'upload_dir' => '/frontend/web/uploads/images/',
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => 'frontend/web/thumbs/images/',
