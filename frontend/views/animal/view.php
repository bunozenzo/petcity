    ...
    <div class="row">
        ...
        <div class="col-md-3 bg_cho" id="content_left">
            ...
            switch ($parent_id) {
                case '1':
                    ?>
                    <div class="top_content_left_dog animal"></div>
                    <?php
                    break;
                case '2':
                    ?>
                    <div class="top_content_left_cat animal"></div>
                    <?php
                    break;
                case '3':
                    ?>
                    <div class="top_content_left_bird animal"></div>
                    <?php
                    break;
                case '4':
                    ?>
                    <div class="top_content_left_fish animal"></div>
                    <?php
                    break;
                case '5':
                    ?>
                    <div class="top_content_left_other animal"></div>
                    <?php
                    break;
            ...
            <div class="cat_left">
                <ul>
                    ...
                    foreach ($datacat as $key => $value) {
                        ?>
                        <li>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/animal/view?slug=<?php echo $value['cat_id']; ?>&parent=<?php echo $value['parent_id']; ?>"><?php echo $value['cat_name']; ?></a>
                        </li>
                        <?php
                    }
                    ?>
                ...
                foreach ($datapro as $key => $value) {
                    ...
                    <li>
                        ...
                        <div class="pro_price">
                           ...
                           ?>
                                <input type="hidden" id="product_price" value="<?php echo number_format($value['pro_price'] * (1 - ($value['pro_sale_off']) / 100), 0, ' ', ',')?>"/>
                                <?php
                            } else {
                                echo '$ ' . number_format($value['pro_price'], 0, ' ', ',');?>
                                <input type="hidden" id="product_price" value="<?php echo  number_format($value['pro_price'], 0, ' ', ',');?>"/>
                                <?php
                            } ?>
